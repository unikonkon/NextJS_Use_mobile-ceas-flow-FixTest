    ...
    <SheetPortal>
      <SheetOverlay
        ...
        className={cn(
          ...
          noAnimation && "animate-none! duration-0!"
        )}
      />
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          cn(
            ...
            !noAnimation && "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right"
          ),
          side === "left" &&
          cn(
            "inset-y-0 left-0 h-full w-3/4 border-r sm:max-w-sm",
            !noAnimation && "data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left"
          ),
          side === "top" &&
          cn(
            "inset-x-0 top-0 h-auto border-b",
            !noAnimation && "data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top"
          ),
          side === "bottom" &&
          cn(
            "inset-x-0 bottom-0 h-auto border-t",
            !noAnimation && "data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom"
          ),
